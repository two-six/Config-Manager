...
* Configuration
An example configuration can be found in *example* directory. It works by copying files from choosen in *themes* directory. Let's look at the provided in example *themes* file to see how to make one yourself
#+begin_src
